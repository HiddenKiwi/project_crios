...
environments {
    ...
    production {
        ...
        //grails.serverURL = "http://rct-pcsladders.elasticbeanstalk.com"
    }
}
...
grails.plugin.springsecurity.userLookup.userDomainClassName = 'pcsladders.user.User'
grails.plugin.springsecurity.userLookup.authorityJoinClassName = 'pcsladders.user.UserRole'
grails.plugin.springsecurity.authority.className = 'pcsladders.user.Role'
